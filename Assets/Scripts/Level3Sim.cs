...
public class Level3Sim : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        writer = new FileWriter(@"level3.csv");
    }
    ...
    void Simulation()
    {
        ...
        // extra damage to tank
        int extraDamage = (int) Math.Round(totalDamagePlayers * 0.01);
        warrior.TakeDamage(extraDamage);
        totalDamageBoss += extraDamage;
    ...
    void EndSim() {
        ...
        // checks max damage
        if (totalDamageBoss > DisplayScores.maxDamageBoss3) {
            DisplayScores.maxDamageBoss3 = totalDamageBoss;
        }
        if (totalDamagePlayers > DisplayScores.maxDamagePlayers3) {
            DisplayScores.maxDamagePlayers3 = totalDamagePlayers;
        }
    }
